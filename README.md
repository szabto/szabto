...
- [Added possibility to configure SAMESITE property of the id token cookie](https://github.com/puiterwijk/flask-oidc/pull/163) on [puiterwijk/flask-oidc](https://github.com/puiterwijk/flask-oidc) (4 weeks ago)
